...
namespace Donut.Console.Commands
{
    ...
    internal class TerminateAssetAccountCommand : ICommand
    {
        ...
        public static void Configure(CommandLineApplication app, CommandLineOptions options, IConsole console)
        {
            ...
            app.OnExecute(
                () =>
                {
                    ...
                    options.Command = new TerminateAssetAccountCommand { assetAccountId = assetAccountId };
                });
        }

        public Task ExecuteAsync(CommandContext context) => context.AssetAccountsClient.TerminateAsync(this.assetAccountId);
